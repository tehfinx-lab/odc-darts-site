...
/**
 * DEEP PLAYER PROFILE — no external chart library (pure SVG graph).
 * Replaces the old PlayerDetailsModal. Adds:
 *  - initials avatar
 *  - form graph (avg over recent matches, hand-drawn SVG)
 *  - win/loss streak + recent form pills
 *  - milestone badges
 *  - recent match list with win/loss colouring
